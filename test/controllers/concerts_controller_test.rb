...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference("Concert.count") do
      post concerts_url, params: { concert: { assistants: @concert.assistants, group_id: @concert.group_id } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { assistants: @concert.assistants, group_id: @concert.group_id } }
